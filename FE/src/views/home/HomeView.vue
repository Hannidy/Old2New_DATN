<template>
  <div class="bg-white text-dark pb-5">
    ...
    <main class="container main-content">
      <div
        id="homeBanner"
        class="carousel slide carousel-fade mb-5 border rounded overflow-hidden shadow-sm"
        ...
        <div class="carousel-inner" style="height: 300px">
          <div class="carousel-item active h-100">
            <img
              ...
              src="https://i.pinimg.com/1200x/02/90/7a/02907ad6256dc7cf4e80e3ace6084f4b.jpg"
              alt="Banner 1"
            />
          </div>
      ...
      <section id="product-section">
        <div
          class="d-flex justify-content-between align-items-end mb-4 border-start border-4 border-danger ps-3"
        >
          <div>
            ...
            <h2 class="fs-4 fw-bold mb-0 text-dark">
              {{
                isSearching
                  ? 'Kết quả tìm kiếm cho: "' + route.query.search + '"'
                  : "Khám phá sản phẩm"
              }}
            </h2>
            <small class="text-muted">
              {{
                isSearching
                  ? "Tìm thấy " + products.length + " sản phẩm khớp với từ khóa"
                  : "Đồ cũ chất lượng - Giá rẻ cho mọi nhà"
              }}
            </small>
          </div>
        ...
        <div v-else class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3">
          <div v-for="product in products" :key="product.sanPhamId" class="col">
            <div class="card h-100 shadow-sm product-card border-0">
              <div
                class="bg-light d-flex align-items-center justify-content-center border-bottom overflow-hidden position-relative"
                style="height: 180px"
              >
                <img
                ...
                <img
                  v-else-if="
                    product.danhSachHinhAnh &&
                    product.danhSachHinhAnh.length > 0 &&
                    product.danhSachHinhAnh[0].duongDanAnh
                  "
                ...
                <span
                  class="position-absolute top-0 start-0 badge bg-warning text-dark m-2 small"
              ...
              <div class="card-body p-2 d-flex flex-column">
                ...
                <div class="mb-2">
                  ...
                  <small class="text-muted">
                    ...
                    {{
                      product.nguoiBan ||
                      (product.nguoiDung && product.nguoiDung.hoVaTen) ||
                      "Ẩn danh"
                    }}
                  </small>
                </div>
