      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- DROPDOWN MENU ĐÃ THÊM ICON -->
            <ul
              class="dropdown-menu shadow custom-user-menu rounded border-0 pb-2"
            >
              ...
              <!-- NHÓM TÀI KHOẢN -->
              <li
                class="px-3 pt-3 pb-1 small fw-bold text-muted text-uppercase"
              ...
              <li>
                ...
                >
                  <i
                    class="bi bi-person fs-5 me-2 text-secondary custom-icon"
                  ></i>
                  Hồ sơ của tôi
                </router-link>
              </li>
              ...
              <li>
                ...
                >
                  <i
                    class="bi bi-cart2 fs-5 me-2 text-secondary custom-icon"
                  ></i>
                  Quản lý đơn mua
                </router-link>
              </li>
              ...
              <li>
                ...
                >
                  <i
                    class="bi bi-shop fs-5 me-2 text-secondary custom-icon"
                  ></i>
                  Hồ sơ cửa hàng
                </router-link>
              </li>
              <li>
                ...
                >
                  <i
                    class="bi bi-card-list fs-5 me-2 text-secondary custom-icon"
                  ></i>
                  Quản lý sản phẩm
                </router-link>
              </li>
              <li>
                ...
                >
                  <i
                    class="bi bi-graph-up fs-5 me-2 text-secondary custom-icon"
                  ></i>
                  Quản lý đơn bán
                </router-link>
              </li>
              ...
              <!-- NHÓM QUẢN TRỊ -->
              <template v-if="currentUser && currentUser.vaiTroId == 1">
                <li
                  class="px-3 pt-3 pb-1 small fw-bold text-muted text-uppercase"
                  style="letter-spacing: 0.5px"
                >
                ...
                <li>
                  <router-link
                    to="/admin/categories"
                    class="dropdown-item py-2 text-primary fw-bold d-flex align-items-center"
                  >
                    <i class="bi bi-gear-fill fs-5 me-2"></i> Hệ thống Admin
                  </router-link>
                </li>
              </template>
              ...
              <li>
                ...
                >
                  <i class="bi bi-box-arrow-right fs-5 me-2"></i> Đăng xuất
                </button>
              </li>
            </ul>
          </div>
...
/* Giữ màu nguyên bản cho icon khi hover nếu muốn */
.custom-user-menu .dropdown-item:hover .custom-icon {
